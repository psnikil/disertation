# -*- coding: utf-8 -*-
"""
Created on Mon Jul 11 12:49:42 2022
...
model = dict(
    ...
    backbone=dict(init_cfg=dict(type='Pretrained', checkpoint='/home/s2258567/models/vfnet_x101_64x4d_fpn_mdconv_c3-c5_mstrain_2x_coco_20201027pth-b5f6da5e.pth'))
    )
